...
//------------------ 样式定义 ---------------------------//
//功能按钮同样样式
var s_tiannet_turn_base = "height:16px;font-size:9pt;color:white;border:0 solid #CCCCCC;cursor:hand;background-color:#53B9F8;";
//翻年、月等的按钮
...
//日期选择控件体的样式
var s_tiannet_body = "width:150;top:30px;background-color:#53B9F8;display:none;z-index:9998;position:absolute;" +
...
// ---------------------- end 用户可调用的函数 -----------------------------//
//------------------ begin 页面显示部分 ---------------------------//
//var document = document.getElementById('ChooseTime');
